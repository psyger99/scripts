# KeePassXC Installation Script

Write-Host "Installing KeePassXC using 'choco'..." -ForegroundColor Cyan
choco upgrade keepassxc -y --exact
...
switch ($exitCode) {
    0 {
        Write-Host "Success: KeePassXC installed successfully!" -ForegroundColor Green
        Exit 0
    }
    3010 {
